...
The mini experiments have been tested on a 32 GB / 8-core Ubuntu 20.04 host, where each run completes in approximately 20 minutes. Other platforms might also work but have not been validated.
...
For more details, see [`docs/mini-scale-experiments.md`](https://github.com/ucd-plse/scalelens/blob/master/docs/mini-scale-experiments.md) in the ScaleLens repository.
